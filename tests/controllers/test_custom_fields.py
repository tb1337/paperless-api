...
from pypaperless.controllers import CustomFieldsController
...
async def test_endpoint(paperless: Paperless) -> None:
    """Test endpoint."""
    assert isinstance(paperless.custom_fields, CustomFieldsController)
    assert isinstance(paperless.custom_fields, CreateMixin | UpdateMixin | DeleteMixin)
