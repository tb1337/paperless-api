...
from pypaperless.controllers import GroupsController
...
async def test_endpoint(paperless: Paperless) -> None:
    """Test endpoint."""
    assert isinstance(paperless.groups, GroupsController)
    assert not isinstance(paperless.groups, CreateMixin | UpdateMixin | DeleteMixin)
