...
from pypaperless.controllers import TagsController
...
async def test_endpoint(paperless: Paperless) -> None:
    """Test endpoint."""
    assert isinstance(paperless.tags, TagsController)
    assert isinstance(paperless.tags, CreateMixin | UpdateMixin | DeleteMixin)
